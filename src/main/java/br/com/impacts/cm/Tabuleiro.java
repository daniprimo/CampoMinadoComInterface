...
public class Tabuleiro implements CampoObservador{
    ...
    private final List<Consumer<ResultadoDoEvento>> observadores =
            new ArrayList<>();
    ...
    //criado para percorrer os campos do tabuleiro
    ...
    public void notificarObservadores (boolean resultado) {
        observadores.stream()
                .forEach(o -> o.accept(new ResultadoDoEvento(resultado)));
    }
